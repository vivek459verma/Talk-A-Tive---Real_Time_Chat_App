...
const DashboardLayout = () => {
  ...
  useEffect(() => {
    if (isLoggedIn) {
      ...
      socket.on("audio_call_notification", (...data) => {
        try {
          console.log("Received audio call notification:", data);
          dispatch(PushToAudioCallQueue(data));
        } catch (error) {
          console.error("Error handling audio call notification:", error);
        }
      });
  ...
  }, [conversations, current_conversation, dispatch, isLoggedIn, user_id]);
